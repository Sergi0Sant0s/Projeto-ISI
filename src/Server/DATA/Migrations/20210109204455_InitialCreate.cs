...
namespace DATA.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "StatPlayerOnGame",
                columns: table => new
                {
                    StatPlayerOnGameId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatPlayerOnGame", x => x.StatPlayerOnGameId);
                    table.ForeignKey(
                        name: "FK_StatPlayerOnGame_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatPlayerOnGame_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatPlayerOnGame_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 1, 14, 20, 44, 55, 194, DateTimeKind.Local).AddTicks(567), new DateTime(2021, 1, 9, 20, 44, 55, 190, DateTimeKind.Local).AddTicks(7833), "Blast New York" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "User@games.com", "User", "User", "User" },
                    { 1, "Admin@games.com", "Admin", "Admin", "Admin" },
                    { 3, "Convidado@games.com", "Convidado", "Convidado", "Convidado" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatPlayerOnGame_GameId",
                table: "StatPlayerOnGame",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_StatPlayerOnGame_PlayerId",
                table: "StatPlayerOnGame",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_StatPlayerOnGame_TeamId",
                table: "StatPlayerOnGame",
                column: "TeamId");
        }
